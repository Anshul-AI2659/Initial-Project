...
export const Russian = {
  signUp: {
    ...
    error: {
      name: 'Пожалуйста, используйте только буквы и минимальная длина — 3 символа.',
      email: 'Пожалуйста, введите действительный адрес электронной почты.',
      password: 'Пароль должен содержать: одну заглавную букву, одну строчную букву, цифру, специальный символ и не менее 8 символов.',
      confirmPassword: 'Пароли не совпадают.',
      mobile: 'Номер мобильного телефона должен содержать от 5 до 13 цифр.'
    },
  },
