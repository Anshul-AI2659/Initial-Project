...
export const Hindi = {
  signUp: {
    ...
    error: {
      name: 'कृपया केवल अक्षरों का उपयोग करें और न्यूनतम लंबाई 3 वर्ण होनी चाहिए।',
  email: 'कृपया मान्य ईमेल दर्ज करें।',
  password: 'पासवर्ड में होना चाहिए: एक बड़ा अक्षर, एक छोटा अक्षर, एक अंक, एक विशेष वर्ण और कम से कम 8 वर्ण।',
  confirmPassword: 'पासवर्ड मेल नहीं खा रहे हैं।',
  mobile: 'मोबाइल नंबर में कम से कम 5 अंक और अधिकतम 13 अंक होने चाहिए।'
    },
  },
